...
public class Mineral {
    ...
    public Mineral(Integer id_mineral, String name, String chemical_formul, String color, String hardness, BigDecimal specific_gravity, String crystal_system, LocalDate fecha_extraccion, Mine mine) {
        this.id_mineral = id_mineral;
        this.name = name;
        this.chemical_formul = chemical_formul;
        this.color = color;
